  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.statusBarContainer}>
        ...
        style={styles.icon}></Image>
        <ProgressBar progress={1} color={'#85BB65'} style={styles.progress}></ProgressBar>
      </View>

      <View style={styles.statusBarContainer}>
        <Image source={require('../../../assets/icons/bodyIcon.png')}
        style={styles.icon}></Image>
        <ProgressBar progress={1} color={'#FF0043'} style={styles.progress}></ProgressBar>
      </View>

      <View style={styles.statusBarContainer}>
        <Image source={require('../../../assets/icons/funIcon.png')}
        style={styles.icon}></Image>
        <ProgressBar progress={1} color={'#FE7F23'} style={styles.progress}></ProgressBar>
      </View>
    </View>
  )
}
